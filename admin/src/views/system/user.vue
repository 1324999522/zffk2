  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20" style="margin-bottom: 20px">
        <el-col :span="4">
          <el-input v-model="page.str" placeholder="请输入用户名" clearable> </el-input>
        </el-col>
        <el-col :span="2.5">
        ...
        <el-table :data="form" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="角色" min-width="120">
            <template slot-scope="scope">
              <el-tag style="margin-right:10px;" v-for="role in scope.row.roles" :key="role.id"> {{role.rolename}}</el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="good_types_count" label="分类数量" min-width="80">
          </el-table-column>
          <el-table-column prop="goods_count" label="商品数量" min-width="80">
          </el-table-column>
          <el-table-column prop="cards_count" label="卡密数量" min-width="80">
          </el-table-column>
          <el-table-column prop="" label="可提现余额" min-width="80">
            <template slot-scope="scope">
              {{scope.row.merchants[0]?scope.row.merchants[0].balance:0}} 元
            </template>
          </el-table-column>
          <!-- 表单操作区域 -->
...
import userUpdate from '@/views/system/user_update'
